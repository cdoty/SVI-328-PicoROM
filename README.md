...
Replace Test.rom in the [rom](rom/) directory, run mk.bat and recompile the firmware. You may have to touch or resave [c/svi-328-cartridge.c](svi-328-cartridge.c). 
